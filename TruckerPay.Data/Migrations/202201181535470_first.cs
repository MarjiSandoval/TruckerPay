namespace TruckerPay.Data.Migrations
{
    ...
    public partial class first : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Weekly_PayDate = c.DateTime(),
                    })
                .PrimaryKey(t => t.LoadPayId)
                .ForeignKey("dbo.Loads", t => t.LoadId, cascadeDelete: true)
                .ForeignKey("dbo.WeeklyPays", t => t.Weekly_PayDate)
                .Index(t => t.LoadId)
                .Index(t => t.Weekly_PayDate);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.LoadPays", "Weekly_PayDate", "dbo.WeeklyPays");
            ...
            DropIndex("dbo.LoadPays", new[] { "Weekly_PayDate" });
